...
ld <- read_delim(paste("subsets_noKTAR_1M/call_set_AGRFlib1_to_6_V2P.rn.QCmaf.scf",f,".AB.noKTAR.nofixed.geno.ld.subset1M",
                       sep=""),delim = "\t")
...
theme_bw()
ggsave(paste("./plots_noKTAR/3000_scf",f,".png",sep=""),
...
###ylab(expression(paste("Average LD (mean ",R^2,")")))+
###theme_bw()
###ggsave(paste("./plots_noKTAR/50000_scf",f,".png",sep=""),
###dpi = 300,width = 7, height = 4, units = "in")
...
ggsave(paste("./plots_noKTAR/nomean_3000_scf",f,".png",sep=""),
       dpi = 300,width = 7, height = 4, units = "in")
...
###xlab("Distance (bp)")+
###ylab(expression(paste("Linkage Desequilibrium (",R^2,")")))
###ggsave(paste("./plots_noKTAR/nomean_50000_scf",f,".png",sep=""),
### dpi = 300,width = 7, height = 4, units = "in")
