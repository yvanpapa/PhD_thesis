#!/bin/bash
#SBATCH --job-name=agat_stats_BM
#SBATCH --cpus-per-task=4
#SBATCH --mem=24G
#SBATCH --partition=quicktest
#SBATCH --time=1:00:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/13_final_gene_stats/BM/stats_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/13_final_gene_stats/BM/stats_%j.err
...
gff=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/12_filter_gene_models/BM/2_flag_filter_ORF/final_outputs_flagged/BMdn_rnd2.mkr.noseq.blstfnc.iprscan.lngthfiltrd.ORFflag.genes_only.gff
perlscript="/nfs/scratch/papayv/Tarakihi/TARdn/11_genome_annotation/2_model_evaluations/AED_cdf_generator.pl"
dir=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/13_final_gene_stats/BM/
