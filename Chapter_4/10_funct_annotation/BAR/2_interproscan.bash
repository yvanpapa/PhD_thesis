#!/bin/bash
#SBATCH --job-name=BAR_interproscan
#SBATCH --cpus-per-task=24
#SBATCH --mem=32G
#SBATCH --partition=quicktest
#SBATCH --time=1:00:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/11_funct_annotation/BAR/2_interproscan/interproscan_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/11_funct_annotation/BAR/2_interproscan/interproscan_%j.err
