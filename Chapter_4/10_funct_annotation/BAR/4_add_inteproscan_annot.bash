#!/bin/bash
#SBATCH --job-name=BAR_iprscan_annot
#SBATCH --cpus-per-task=2
#SBATCH --mem=4G
#SBATCH --partition=quicktest
#SBATCH --time=30:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/11_funct_annotation/BAR/4_annotation_interproscan/iprscan_annot_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/11_funct_annotation/BAR/4_annotation_interproscan/iprscan_annot_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=yvan.papa@vuw.ac.nz

source activate genome_annotation

indir=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/11_funct_annotation/BAR/3_annotation/functannot_output_protID/
dir=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/11_funct_annotation/BAR/4_annotation_interproscan/
iprdir=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/11_funct_annotation/BAR/2_interproscan
name1=BARdn_rnd2.all.maker.noseq.blastfunc_annotated
name2=BARdn_rnd2.all.maker.blastfunc_annotated
...
iprscan2gff3 $iprscan_file $outdir/$name1.iprscan.gff > $outdir/BARdn_rnd2.visible_iprscan_domains.gff
