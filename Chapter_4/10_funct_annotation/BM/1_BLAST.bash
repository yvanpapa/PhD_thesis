...
proteins=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BM/4_rename_outputs/maker_renamed_outputs/BMdn_rnd2.all.maker.proteins.fasta


blastp -db $db -query $proteins -num_threads $threads \
-evalue 1e-6 -max_hsps 1 -max_target_seqs 1 -outfmt 6 -out $dir/BMdn_rnd2.all.maker.proteins_blast_nr.out
