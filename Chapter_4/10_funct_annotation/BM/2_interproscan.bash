#!/bin/bash
#SBATCH --job-name=BM_interproscan
#SBATCH --cpus-per-task=24
#SBATCH --mem=32G
#SBATCH --partition=quicktest
#SBATCH --time=1:00:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/11_funct_annotation/BM/2_interproscan/interproscan_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/11_funct_annotation/BM/2_interproscan/interproscan_%j.err
...
proteins=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BM/4_rename_outputs/maker_renamed_outputs/BMdn_rnd2.all.maker.proteins.noasterisk.fasta
