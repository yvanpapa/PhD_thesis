#!/bin/bash
#SBATCH --job-name=BT_blast_annotation_custom
#SBATCH --cpus-per-task=2
#SBATCH --mem=4G
#SBATCH --partition=parallel
#SBATCH --time=2:00:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/11_funct_annotation/BT/3_annotation/blast_functannot_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/11_funct_annotation/BT/3_annotation/blast_functannot_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=yvan.papa@vuw.ac.nz

dir=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/11_funct_annotation/BT/3_annotation/
...
blast_file=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/11_funct_annotation/BT/1_ncbi_blast/BTdn_rnd2.all.maker.proteins_blast_nr.out_total
gff=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BT/4_rename_outputs/maker_renamed_outputs/BTdn_rnd2.all.maker.noseq.gff
gff2=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BT/4_rename_outputs/maker_renamed_outputs/BTdn_rnd2.all.maker.gff
prots="/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BT/4_rename_outputs/maker_renamed_outputs/BTdn_rnd2.all.maker.proteins.fasta"
trscrpts="/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BT/4_rename_outputs/maker_renamed_outputs/BTdn_rnd2.all.maker.transcripts.fasta"
...
#awk -F'\t' 'NR==FNR{a[$1]=$2; next}{split($9,b,";");gsub("ID=","",b[1]);gsub("-RA","",b[1]);gsub(/;$/,"",$0);if(a[b[1]] != ""){print $0";Note=blastp: "a[b[1]];} else {print $0";"}}' $dir/file3 $gff > $dir/functannot_output/BTdn_rnd2.all.maker.noseq.blastfunc_annotated.gff
#THis works:
#awk -F'\t' 'NR==FNR{a[$1]=$2; next}{split($9,b,";");gsub("ID=","",b[1]);gsub("-RA","",b[1]);gsub(/;$/,"",$0);if(a[b[1]] != ""){print $0";Note=blastp: "a[b[1]];} else {print $0";"}}' $dir/file3 $gff2 > $dir/functannot_output/BTdn_rnd2.all.maker.blastfunc_annotated.gff
...
awk -F'\t' 'NR==FNR{a[$1]=$2; next}{split($9,b,";");gsub("ID=","",b[1]);gsub("-RA","",b[1]);gsub(/;$/,"",$0);if(a[b[1]] != ""){print $0";Note=blastp:"a[b[1]];} else {print $0";"}}' $dir/file3.2 $gff > $dir/functannot_output_protID/BTdn_rnd2.all.maker.noseq.blastfunc_annotated.gff

awk -F'\t' 'NR==FNR{a[$1]=$2; next}{split($9,b,";");gsub("ID=","",b[1]);gsub("-RA","",b[1]);gsub(/;$/,"",$0);if(a[b[1]] != ""){print $0";Note=blastp:"a[b[1]];} else {print $0";"}}' $dir/file3.2 $gff2 > $dir/functannot_output_protID/BTdn_rnd2.all.maker.blastfunc_annotated.gff
...
> $dir/functannot_output_protID/BTdn_rnd2.all.maker.proteins.blastfunc_annotated.fasta
##Remove ;
sed -i 's/;//' $dir/functannot_output_protID/BTdn_rnd2.all.maker.proteins.blastfunc_annotated.fasta

awk -F'\t' 'NR==FNR{a[$1]=$2; next}{if($0 ~ /^>/){split($1,v," ");gsub(">","",v[1]);gsub("-RA","",v[1]);print $0" Note=blastp: "a[v[1]]}else{print $0}}' $dir/file3.2 $trscrpts \
> $dir/functannot_output_protID/BTdn_rnd2.all.maker.transcripts.blastfunc_annotated.fasta
##Remove ;
sed -i 's/;//' $dir/functannot_output_protID/BTdn_rnd2.all.maker.transcripts.blastfunc_annotated.fasta
