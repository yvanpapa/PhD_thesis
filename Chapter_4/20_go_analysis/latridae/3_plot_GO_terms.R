setwd("G:/DATA/WORK/WGS_PIPELINE/4_fish_assemblies/24_paml_selection/pipeline4_latridae")

library(ggplot2)
# Basic barplot

df_GOterms<-read.delim("G:/DATA/WORK/WGS_PIPELINE/4_fish_assemblies/24_paml_selection/pipeline4_latridae/count_goterms_functions_latridae.txt")
