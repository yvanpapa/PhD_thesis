...
#SBATCH --time=2:00:00
#SBATCH --job-name=codeml_array_latridae
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/24_paml_selection/selection_latridae/job_files/codeml_latridae_array_%A_%a.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/24_paml_selection/selection_latridae/job_files/codeml_latridae_array_%A_%a.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=yvan.papa@vuw.ac.nz

#30 minutes is too short for some of the jobs
#Some of the jobs will fail, it's okay: some of the orthologs are empty sequences
...
#Get the tree
cp /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/24_paml_selection/selection_latridae/codeml_tree_latridae.nwk $workdir/
...
#Get the two ctl files. you just need to change the line for the tree name because we will change the other relevant lines in the script
cp /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/24_paml_selection/selection_latridae/alternative.ctl $workdir/
...
cp /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/24_paml_selection/selection_latridae/null_model.ctl $workdir/
