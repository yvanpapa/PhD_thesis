#!/bin/bash
#SBATCH --job-name=BT_repeatmasker
...
assembly=BTdn_assembly_V1_srn.fasta
repeat_library=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/9_repeat_masking/BT/BTdn_V1_repeat_lib_TARV2Pdb_and_denovo.fa
