#!/bin/bash
#SBATCH --job-name=BT_run1_masurca
#SBATCH --cpus-per-task=32
#SBATCH --mem=600G
#SBATCH --partition=bigmem
#SBATCH --time=10-00:00:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/7_masurca/BT/run1/%j_out_run1_BT
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/7_masurca/BT/run1/%j_err_run1_BT
...
CONFIG_PATH="/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/7_masurca/BT/run1/sr_config_runBT.txt"
...
rename_filter_fastq 'pe' <(exec expand_fastq '/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/4b_bwa_mitogenome/014_BT02.mitogenome.unmapped.end1.fq.gz' | awk '{if(length($0>250)) print substr($0,1,250); else print $0;}') <(exec expand_fastq '/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/4b_bwa_mitogenome/014_BT02.mitogenome.unmapped.end2.fq.gz' | awk '{if(length($0>250)) print substr($0,1,250); else print $0;}' ) > 'pe.renamed.fastq'
