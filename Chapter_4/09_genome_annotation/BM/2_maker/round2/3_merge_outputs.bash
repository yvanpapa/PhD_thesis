#!/bin/bash
#SBATCH --job-name=merge_outputs_BMrnd2
#SBATCH --cpus-per-task=2
#SBATCH --mem=96G
#SBATCH --partition=bigmem
#SBATCH --time=1-6:00:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BM/maker/round2/merge_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BM/maker/round2/merge_%j.err
...
read_dir=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BM/maker/round2/BMdn_rnd2.maker.output/
index_log=$read_dir/BMdn_rnd2_master_datastore_index.log
name=BMdn_rnd2
