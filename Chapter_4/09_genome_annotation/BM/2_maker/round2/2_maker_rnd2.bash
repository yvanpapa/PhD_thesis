#!/bin/bash
#SBATCH --job-name=BM_maker_rnd2
#SBATCH --cpus-per-task=48
#SBATCH --mem=96G
#SBATCH --partition=bigmem
#SBATCH --time=2-00:00:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BM/maker/round2/maker_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BM/maker/round2/maker_%j.err
...
dir=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BM/maker/round2/

echo "start maker"
mpiexec -n $threads maker -base BMdn_rnd2 $dir/BMdn_rnd2_maker_opts.ctl $dir/maker_bopts.ctl $dir/maker_exe.ctl
echo "done"
