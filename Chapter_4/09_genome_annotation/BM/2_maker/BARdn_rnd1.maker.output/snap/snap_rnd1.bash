#!/bin/bash
#SBATCH --job-name=convert_to_zff_BM
#SBATCH --cpus-per-task=2
#SBATCH --mem=4G
#SBATCH --partition=parallel
#SBATCH --time=6:00:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BM/maker/BMdn_rnd1.maker.output/snap/snap_rnd1_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BM/maker/BMdn_rnd1.maker.output/snap/snap_rnd1_%j.err
...
index_log=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BM/maker/BMdn_rnd1.maker.output/BMdn_rnd1_master_datastore_index.log
#gff_file=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BM/maker/BMdn_rnd1.maker.output/BMdn_rnd1.all.maker.gff
dir=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BM/maker/BMdn_rnd1.maker.output/snap/
name=BMdn_rnd1
