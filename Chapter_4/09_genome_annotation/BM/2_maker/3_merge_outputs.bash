#!/bin/bash
#SBATCH --job-name=merge_outputs_BM
#SBATCH --cpus-per-task=2
#SBATCH --mem=24G
#SBATCH --partition=bigmem
#SBATCH --time=3:00:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BM/maker/merge_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BM/maker/merge_%j.err
...
read_dir=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BM/maker/BMdn_rnd1.maker.output/
index_log=$read_dir/BMdn_rnd1_master_datastore_index.log
name=BMdn_rnd1
