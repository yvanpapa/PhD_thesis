#!/bin/bash
#SBATCH --job-name=merge_outputs_KArnd2
#SBATCH --cpus-per-task=2
#SBATCH --mem=24G
#SBATCH --partition=parallel
#SBATCH --time=6:00:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/maker/round2/merge_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/maker/round2/merge_%j.err
...
read_dir=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/maker/round2/KAdn_rnd2.maker.output/
index_log=$read_dir/KAdn_rnd2_master_datastore_index.log
name=KAdn_rnd2
