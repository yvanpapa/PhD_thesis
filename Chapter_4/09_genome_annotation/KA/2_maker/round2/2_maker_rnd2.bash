#!/bin/bash
#SBATCH --job-name=KA_maker_rnd2
#SBATCH --cpus-per-task=24
#SBATCH --mem=32G
#SBATCH --partition=parallel
#SBATCH --time=3-00:00:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/maker/round2/maker_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/maker/round2/maker_%j.err
...
dir=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/maker/round2/

echo "start maker"
mpiexec -n $threads maker -base KAdn_rnd2 $dir/KAdn_rnd2_maker_opts.ctl $dir/maker_bopts.ctl $dir/maker_exe.ctl
echo "done"
