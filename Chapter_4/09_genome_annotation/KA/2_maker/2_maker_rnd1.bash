#!/bin/bash
#SBATCH --job-name=maker_KA
#SBATCH --cpus-per-task=32
#SBATCH --mem=64G
#SBATCH --partition=parallel
#SBATCH --time=4-11:30:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/maker/maker_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/maker/maker_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=yvan.papa@vuw.ac.nz
threads=32 #I think the threads dont use the full cpus so it's ok to ask more...
...
dir=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/maker/

echo "start maker"
mpiexec -n $threads maker -base KAdn_rnd1 $dir/KA_rnd1_maker_opts.ctl $dir/maker_bopts.ctl $dir/maker_exe.ctl
echo "done"
