#!/bin/bash
#SBATCH --job-name=augustus_KA
#SBATCH --cpus-per-task=8
#SBATCH --mem=128G
#SBATCH --partition=bigmem
#SBATCH --time=5-00:00:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/maker/KAdn_rnd1.maker.output/augustus/augustus_rnd1_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/maker/KAdn_rnd1.maker.output/augustus/augustus_rnd1_%j.err
...
gff=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/maker/KAdn_rnd1.maker.output/KAdn_rnd1.all.maker.noseq.gff
genome=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/Genome_assemblies/KA/KAdn_assembly_V1_srn.fasta
name=KAdn_rnd1
dir=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/maker/KAdn_rnd1.maker.output/augustus/
