#!/bin/bash
#SBATCH --job-name=convert_to_zff_KA
#SBATCH --cpus-per-task=2
#SBATCH --mem=4G
#SBATCH --partition=parallel
#SBATCH --time=6:00:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/maker/KAdn_rnd1.maker.output/snap/snap_rnd1_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/maker/KAdn_rnd1.maker.output/snap/snap_rnd1_%j.err
...
index_log=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/maker/KAdn_rnd1.maker.output/KAdn_rnd1_master_datastore_index.log
#gff_file=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/maker/KAdn_rnd1.maker.output/KAdn_rnd1.all.maker.gff
dir=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/maker/KAdn_rnd1.maker.output/snap/
name=KAdn_rnd1
