#!/bin/bash
#SBATCH --job-name=busco_gene_models_KA
#SBATCH --cpus-per-task=32
#SBATCH --mem=120G
#SBATCH --partition=bigmem
#SBATCH --time=1-10:00:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/3_model_evaluations/busco_genemodels_job_%A_%a.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/KA/3_model_evaluations/busco_genemodels_job_%A_%a.err
...
time python $busco_scripts_path/run_BUSCO.py -i $dir/KAdn_round1.all.maker.proteins.fasta -o busco_prots_round1 -l $lineage \
  -m proteins -c $threads -sp King_Tarakihi -z --augustus_parameters='--progress=true'
  
echo "transcripts round1"
time python $busco_scripts_path/run_BUSCO.py -i $dir/KAdn_round1.all.maker.transcripts.fasta -o busco_mrna_round1 -l $lineage \
  -m transcriptome -c $threads -sp King_Tarakihi -z --augustus_parameters='--progress=true'
  
  echo "proteins round2"
time python $busco_scripts_path/run_BUSCO.py -i $dir/KAdn_round2.all.maker.proteins.fasta -o busco_prots_round2 -l $lineage \
  -m proteins -c $threads -sp King_Tarakihi -z --augustus_parameters='--progress=true'
  
echo "transcripts round2"
time python $busco_scripts_path/run_BUSCO.py -i $dir/KAdn_round2.all.maker.transcripts.fasta -o busco_mrna_round2 -l $lineage \
  -m transcriptome -c $threads -sp King_Tarakihi -z --augustus_parameters='--progress=true'
