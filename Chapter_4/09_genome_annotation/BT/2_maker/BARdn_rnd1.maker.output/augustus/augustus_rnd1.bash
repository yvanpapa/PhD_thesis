#!/bin/bash
#SBATCH --job-name=augustus_BT
#SBATCH --cpus-per-task=8
#SBATCH --mem=128G
#SBATCH --partition=bigmem
#SBATCH --time=20:00:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BT/maker/BTdn_rnd1.maker.output/augustus/augustus_rnd1_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BT/maker/BTdn_rnd1.maker.output/augustus/augustus_rnd1_%j.err
...
gff=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BT/maker/BTdn_rnd1.maker.output/BTdn_rnd1.all.maker.noseq.gff
genome=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/Genome_assemblies/BT/BTdn_assembly_V1_srn.fasta
name=BTdn_rnd1
dir=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BT/maker/BTdn_rnd1.maker.output/augustus/
