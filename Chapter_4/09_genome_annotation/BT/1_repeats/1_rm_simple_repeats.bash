#!/bin/bash
#SBATCH --job-name=rm_simple_repeats_BT
#SBATCH --cpus-per-task=4
#SBATCH --mem=4G
#SBATCH --partition=quicktest
#SBATCH --time=1:00:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BT/repeats/1_rm_simple_repeats_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BT/repeats/1_rm_simple_repeats_%j.err
...
dir=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BT/repeats/
out_file="/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/Genome_assemblies/BT/BTdn_assembly_V1_srn.fasta.out"
