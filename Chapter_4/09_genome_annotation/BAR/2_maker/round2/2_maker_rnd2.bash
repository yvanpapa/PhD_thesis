#!/bin/bash
#SBATCH --job-name=BAR_maker_rnd2
#SBATCH --cpus-per-task=48
#SBATCH --mem=128G
#SBATCH --partition=bigmem
#SBATCH --time=3-00:00:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BAR/maker/round2/maker_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BAR/maker/round2/maker_%j.err
...
dir=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BAR/maker/round2/

echo "start maker"
mpiexec -n $threads maker -base BARdn_rnd2 $dir/BARdn_rnd2_maker_opts.ctl $dir/maker_bopts.ctl $dir/maker_exe.ctl
echo "done"
