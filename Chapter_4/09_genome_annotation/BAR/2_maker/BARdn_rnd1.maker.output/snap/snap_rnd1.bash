#!/bin/bash
#SBATCH --job-name=convert_to_zff_BAR
#SBATCH --cpus-per-task=2
#SBATCH --mem=4G
#SBATCH --partition=parallel
#SBATCH --time=2-00:00:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BAR/maker/BARdn_rnd1.maker.output/snap/snap_rnd1_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BAR/maker/BARdn_rnd1.maker.output/snap/snap_rnd1_%j.err
...
index_log=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BAR/maker/BARdn_rnd1.maker.output/BARdn_rnd1_master_datastore_index.log
#gff_file=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BAR/maker/BARdn_rnd1.maker.output/BARdn_rnd1.all.maker.gff
dir=/nfs/scratch/papayv/Tarakihi/TARdn/Z_fish_assemblies/10_genome_annotation/BAR/maker/BARdn_rnd1.maker.output/snap/
name=BARdn_rnd1
