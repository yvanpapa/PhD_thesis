#!/bin/bash
#SBATCH --job-name=frc2p
#SBATCH --cpus-per-task=8
#SBATCH --mem-per-cpu=2G
#SBATCH --partition=quicktest
#SBATCH --time=1:00:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/8C_Genomes_Comparisons_FRC/V2P/%j_job_out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/8C_Genomes_Comparisons_FRC/V2P/%j_job_err
...
assembly_version=V2P
bamfile=aln_pe_TARdn_V2P.bam
