...
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/8C_Genomes_Comparisons_FRC/%job_out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/8C_Genomes_Comparisons_FRC/%job_err
...
output_dir=/nfs/scratch/papayv/Tarakihi/TARdn/8C_Genomes_Comparisons_FRC/V2
R1=TARdn_clean_illumina_R1.fastq
R2=TARdn_clean_illumina_R2.fastq
output_name=TARdn_V2
