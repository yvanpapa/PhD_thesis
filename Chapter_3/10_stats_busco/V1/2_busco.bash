...
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/08_Assembly_stats/job_busco_zeb_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/08_Assembly_stats/job_busco_zeb_%j.err
...
time python $busco_scripts_path/run_BUSCO.py -i $assembly -o busco1_zebrafish -l $lineage -m genome -c 6 -sp zebrafish
