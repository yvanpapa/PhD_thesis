...
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/08_Assembly_stats/RUN2/job_busco_zeb_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/08_Assembly_stats/RUN2/job_busco_zeb_%j.err
...
assembly=/nfs/scratch/papayv/Tarakihi/TARdn/07_MASURCA/RUN2_V3_4_1/flye/assembly.fasta
...
time python $busco_scripts_path/run_BUSCO.py -i $assembly -o busco2_zebrafish -l $lineage -m genome -c 6 -sp zebrafish
