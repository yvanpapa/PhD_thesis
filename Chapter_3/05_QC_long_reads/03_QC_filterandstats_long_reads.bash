...
#SBATCH --time=3-1:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/06_QC_longreads/job_out_QC_filterandstat
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/06_QC_longreads/job_err_QC_filterandstat
...
time gunzip -c $Cell3 | NanoFilt --logfile $output_dir/NanoFilt_logfile_Cell3 -q 7 -l 500 --headcrop 50 --summary $sumCell3 | gzip > $output_dir/nanopore_cell3_trimmed.fastq.gz
echo "starting QC Stats"
time NanoStat --fastq $output_dir/nanopore_cell3_trimmed.fastq.gz --name $output_dir/QC_summary_nanopore_cell3_filtertrimmed
echo "quatre-vingt-douze FAR"