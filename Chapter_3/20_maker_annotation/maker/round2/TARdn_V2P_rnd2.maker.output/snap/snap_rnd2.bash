#!/bin/bash
#SBATCH --job-name=snap_round2
#SBATCH --cpus-per-task=8
#SBATCH --mem=12G
#SBATCH --partition=quicktest
#SBATCH --time=45:00
#SBATCH -o /nfs/scratch/papayv/Tarakihi/TARdn/11_genome_annotation/maker/TRIAL2_TARdn_V2P/round2/TARdn_V2P_rnd2.maker.output/snap/round2/snap_rnd2_%j.out
#SBATCH -e /nfs/scratch/papayv/Tarakihi/TARdn/11_genome_annotation/maker/TRIAL2_TARdn_V2P/round2/TARdn_V2P_rnd2.maker.output/snap/round2/snap_rnd2_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=yvan.papa@vuw.ac.nz

#/!\ I think that maker2zff has to run in the TARdn_V2P_rnd2.maker.output directory for some reason
...
index_log=/nfs/scratch/papayv/Tarakihi/TARdn/11_genome_annotation/maker/TRIAL2_TARdn_V2P/round2/TARdn_V2P_rnd2.maker.output/TARdn_V2P_rnd2_master_datastore_index.log
#gff_file="/nfs/scratch/papayv/Tarakihi/TARdn/11_genome_annotation/maker/TRIAL2_TARdn_V2P/round2/TARdn_V2P_rnd2.maker.output/TARdn_V2P_rnd2.all.maker.gff"
dir=/nfs/scratch/papayv/Tarakihi/TARdn/11_genome_annotation/maker/TRIAL2_TARdn_V2P/round2/TARdn_V2P_rnd2.maker.output/snap/round2/
name=TARdn_V2P_rnd2
